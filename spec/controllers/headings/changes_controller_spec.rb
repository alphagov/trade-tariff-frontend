...
describe Headings::ChangesController, "GET to #index", type: :controller do
  ...
  pending 'heading is valid at given date', vcr: { cassette_name: "headings_changes#index" }  do
    before(:each) do
  ...
  pending 'heading has no changes at given date', vcr: { cassette_name: "headings_changes#index_0101000000_1972-01-01" } do
    before(:each) do
  ...
  pending 'heading is not valid at given date', vcr: { cassette_name: "headings_changes#index_0101000000_1970-01-01" } do
    before(:each) do
